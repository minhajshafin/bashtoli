          ...
          <li key={label}>
            {external || href.startsWith('http') ? (
              <a
                ...
                className="text-sm text-forest-400 hover:text-gold-400 transition-colors inline-flex items-center gap-1.5"
      ...
      <div className="mx-auto max-w-7xl px-5 py-16 md:px-8">
        ...
        <div className="pt-8 border-t border-forest-800 flex flex-col md:flex-row justify-between items-center gap-4">
          <div className="flex flex-col sm:flex-row items-center gap-3 text-center sm:text-left">
            <p className="text-xs text-gold-400" style={{ fontWeight: 500 }}>
              Found a bug? Don&apos;t panic &mdash; roast our code or send a PR ➜
            </p>
            <a
              href="https://github.com/minhajshafin/bashtoli"
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-2 text-xs font-semibold px-3.5 py-1.5 rounded-full bg-forest-900 border border-forest-800 text-gold-400 hover:bg-forest-800 hover:text-gold-300 transition-all shrink-0"
            >
