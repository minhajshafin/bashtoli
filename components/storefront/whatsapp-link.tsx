...
export function WhatsAppLink({ orderNumber }: WhatsAppLinkProps) {
  const whatsappNumber = process.env.NEXT_PUBLIC_WHATSAPP_NUMBER || '8801825414737'
  ...
  return (
    <a
      ...
      className="inline-flex h-12 items-center justify-center gap-2 rounded-full bg-emerald-600 px-6 text-sm font-semibold text-white shadow-sm hover:bg-emerald-500 transition-all active:scale-[0.98]"
    >
